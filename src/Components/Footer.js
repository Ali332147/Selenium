...
const Footer = () => {
  return (
    <div className="">
      <footer class="footer flex justify-evenly p-10 bg-base-200 text-base-content ">
      ...
      <footer class=" flex justify-evenly footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div class="items-center grid-flow-col">
          <svg
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            class="fill-curren bg-success rounded-full"
          >
